...
ggplot(data = allele_fq, 
  ...
  geom_histogram(bins = 11,  # using bins = 11 as stated in directions 
                 ...
                 mapping = aes(fill = after_stat(count))) + # Filling in each mapping bin count to better see each distirbution bar 
  ...
  scale_fill_gradient(low = "#7286D3", high = "#88C9BF") + # creating a manual scale gradient using pastel colors to see the count distribution 
