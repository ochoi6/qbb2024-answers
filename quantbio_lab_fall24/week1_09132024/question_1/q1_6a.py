...
## Instructions : 
    # 1) Simulate sequencing 3x coverage of a 1 Mb genome with 100 bp reads
...
#print(number_of_reads) # -> number_of_reads = 300000
...
print("Start position:", start_position) # Start position = 977749
print("End position:", end_position) # End position = 977849
print("Genome coverage:", genome_coverage) # Genome coverage: [0 1 1 ... 4 1 0]


numpy.savetxt('q1_6_genome_coverage.txt', genome_coverage, fmt='%d')
