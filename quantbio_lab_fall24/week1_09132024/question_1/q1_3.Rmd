...
# Read in the file produced from question 1.2 python file and rename it to 'gc_1_3'
gc_1_3 <- read_tsv("/Users/cmdb/qbb2024-answers/quantbio_lab_fall24/week1_09132024/question_1/q1_2_genome_coverage.txt", col_names = FALSE)
...
histogram_plot <- ggplot(gc_1_3, aes(x = X1)) +
  geom_histogram(aes(y = ..count..), binwidth = 1, color = "black", fill = "lightskyblue3") +
  labs(title = "Histogram of the genome coverage with poisson and normal distributions for 3x coverage",
...
poisson_values <- dpois(gc_1_3$X1, lambda = 3) * 1000000
...
normal_values <- dnorm(gc_1_3$X1, mean = mean_coverage, sd = stddev_coverage) * 1000000
...
# Saving the histogram as 'ex1_3x_cov.png' 
ggsave("ex1_3x_cov.png", plot = histogram_plot)
