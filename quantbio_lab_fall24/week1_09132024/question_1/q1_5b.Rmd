...
# Read in the file produced from question 1.5a python file and rename it to 'gc_1_5'
gc_1_5 <- read_tsv("/Users/cmdb/qbb2024-answers/quantbio_lab_fall24/week1_09132024/question_1/q1_5_genome_coverage.txt", col_names = FALSE)
...
histogram_plot <- ggplot(gc_1_5, aes(x = X1)) +
  geom_histogram(aes(y = ..count..), binwidth = 1, color = "black", fill = "lightskyblue3") +
  labs(title = "Histogram of the genome coverage with poisson and normal distributions for 10x coverage",
...
poisson_values <- dpois(gc_1_5$X1, lambda = 10) * 1000000
...
normal_values <- dnorm(gc_1_5$X1, mean = mean_coverage, sd = stddev_coverage) * 1000000
...
# Saving the histogram as 'ex1_10x_cov.png' 
ggsave("ex1_10x_cov.png", plot = histogram_plot)
