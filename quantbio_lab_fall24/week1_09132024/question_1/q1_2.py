...
#print(number_of_reads) # -> number_of_reads = 30000
...
print("Start position:", start_position) # Start position: 301191
print("End position:", end_position) # End position: 301291
print("Genome coverage:", genome_coverage) # Genome coverage: [0 0 0 ... 0 0 0]


numpy.savetxt('q1_2_genome_coverage.txt', genome_coverage, fmt='%d')
